package com.jindam.app.banner.exception;
 ...
 */
public class BannerException extends MasterException {
     ...
     */
    public BannerException(Reason reason) {
        super(reason);
    }
     ...
     * @param reason 예외의 원인을 설명하는 `Reason` 객체
     */
    public BannerException(Reason reason, String customMessage) {
     ...
     * @param reason 예외의 원인을 설명하는 `Reason` 객체
     */
    public BannerException(Reason reason, String prefix, String suffix) {
