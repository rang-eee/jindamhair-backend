...
public class AppointmentController extends MasterController {
    ...
    @PatchMapping("")
    public ApiResultDto<AppointmentDetailResponseDto> updateAppointment(AppointmentUpdateRequestDto request) {
        ApiResultDto<AppointmentDetailResponseDto> apiResultVo = new ApiResultDto<>();
        AppointmentDetailResponseDto result;

        result = appointmentService.updateAppointment(request);
    ...
    public ApiResultDto<AppointmentDetailResponseDto> deleteAppointment(AppointmentDeleteRequestDto request) {
        ...
        result = appointmentService.deleteAppointment(request);
