package com.jindam.app.user.exception;
 ...
 */
public class UserException extends MasterException {
     ...
     * @param reason 예외의 원인을 설명하는 `Reason` 객체
     */
    public UserException(Reason reason, String customMessage) {
     ...
     * @param reason 예외의 원인을 설명하는 `Reason` 객체
     */
    public UserException(Reason reason, String prefix, String suffix) {
