...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "채팅 메시지 생성 요청 모델 (Flutter 호환)")
public class ChatMessageCreateRequestDto {
	...
	@Schema(description = "메시지 타입 코드 (예: MessageType.text)")
	private String messageType;

	@Schema(description = "메시지 내용 타입 코드 (예: MessageTextType.basic)")
	...
	@Schema(description = "삭제 멤버 UID 배열(문자열)")
